    ...
    return (
        <div style={{ backgroundColor: 'var(--color-cream)', minHeight: '100vh' }}>
            ...
            <section
                style={{
                    position: 'relative',
                    height: '50vh', // Shorter hero so the next section is immediately visible
                    minHeight: '400px',
                    display: 'flex',
            ...
            >
                ...
                <div
                    style={{
                        position: 'absolute',
                        inset: 0,
                        backgroundImage: 'url(/src/assets/images/about_clinic_exterior.png)',
                ...
                <div className="container" style={{ position: 'relative', zIndex: 1, padding: '0 1.5rem', marginTop: '3rem' }}>
                    <FadeIn>
                        <h1 style={{
                            ...
                            Our <span style={{ fontFamily: 'var(--font-heading)', fontStyle: 'normal' }}>STORY</span>
                        </h1>
                        <p style={{
                            ...
                            Natural Results. Transparent Care. True Confidence.
                        </p>
                    </FadeIn>
                </div>
            </section>
            ...
            {/* ── Stats Bar ── */}
            {/* Pull upwards by exactly half of its height to straddle the transition */}
            <div style={{ position: 'relative', zIndex: 20, marginTop: '-5rem' }}>
                <StatsBar />
            </div>

            {/* ── Meet Elena ── */}
            <section style={{ paddingTop: '7rem', paddingBottom: '6rem', position: 'relative', zIndex: 1 }}>
